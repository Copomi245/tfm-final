...
async function getFullTweets(busqueda1, busqueda2, busqueda3, busqueda4, fechaDesde, fechaHasta) {
    ...
    if (tabs.length >= 2) {
       ...
       const firstPost = await page.$('div[role="link"][tabindex="0"]');  // Capturamos el primer post
...
if (firstPost) {
    ...
    console.log("1")
     ...
     try {
        ...
        await page.waitForSelector('div[role="link"][tabindex="0"]', { timeout: 30000, state: 'attached' });
...
const POST_SELECTOR = 'div[role="link"][tabindex="0"]';
